...
pub enum ClipContent {
    AudioFile { path: String, sample_rate: u32 },
    VideoFile { path: String, frame_rate: f64 },
    ImageFile { path: String },
    Effect { effect_id: String, parameters: std::collections::HashMap<String, serde_json::Value> },
...
impl TimelinePanel {
    ...
    fn render_track_content(&self, ui: &mut egui::Ui, track: &Track, width: f32) {
        ...
        for clip in &track.clips {
            ...
            painter.rect_stroke(clip_rect, 2.0, egui::Stroke::new(1.0, egui::Color32::from_rgb(100, 100, 100)));
    ...
    fn render_playhead(&self, ui: &mut egui::Ui, width: f32, header_height: f32) {
        ...
        if playhead_x >= 0.0 && playhead_x <= width {
            ...
            painter.line_segment(
                [egui::pos2(playhead_x, playhead_top), egui::pos2(playhead_x, playhead_bottom)],
