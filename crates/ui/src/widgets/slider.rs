            ...
            SliderOrientation::Horizontal => {
                ui.horizontal(|ui| {
                    ...
                    let slider_response = if let Some(step) = self.step {
                        ...
                        let response = ui.add(egui::Slider::new(&mut value, self.min..=self.max)
                            .step_by(step)
    ...
    pub fn render(&mut self, ui: &mut egui::Ui) -> bool {
        ...
        ui.horizontal(|ui| {
            ...
            let response = if let Some(step) = self.step {
                ui.add(egui::Slider::new(&mut start, self.min..=self.end)
                    .step_by(step)
            ...
            let response = if let Some(step) = self.step {
                ui.add(egui::Slider::new(&mut end, self.start..=self.max)
                    .step_by(step)
                    .show_value(self.show_values)
                    .text("End"));
            } else {
