    ...
    ConversionConfig {
      input_config: InputConfig {
        input_path: other
          ...
          .input_path
          .clone()
          .or(self.input_config.input_path.clone()),
        input_stream: other
          .input_config
          .input_stream
          .clone()
          .or(self.input_config.input_stream.clone()),
        input_format: other
          .input_config
          .input_format
          .clone()
          .or(self.input_config.input_format.clone()),
        input_encoding: other
          .input_config
          .input_encoding
          .clone()
          .or(self.input_config.input_encoding.clone()),
        input_validation: other.input_config.input_validation,
        auto_detect_format: other.input_config.auto_detect_format,
        chunk_size: other
          .input_config
          .chunk_size
          .max(self.input_config.chunk_size),
        buffer_size: other
          .input_config
          .buffer_size
          .max(self.input_config.buffer_size),
      },
      output_config: OutputConfig {
        output_path: other
          ...
          .output_path
          .clone()
          .or(self.output_config.output_path.clone()),
        output_stream: other
          .output_config
          .output_stream
          .clone()
          .or(self.output_config.output_stream.clone()),
        output_format: other.output_config.output_format.clone(),
        output_encoding: other
          .output_config
          .output_encoding
          .clone()
          .or(self.output_config.output_encoding.clone()),
        output_directory: other
          .output_config
          .output_directory
          .clone()
          .or(self.output_config.output_directory.clone()),
        create_subdirectories: other.output_config.create_subdirectories
          || self.output_config.create_subdirectories,
        overwrite_existing: other.output_config.overwrite_existing
          || self.output_config.overwrite_existing,
        create_backup: other.output_config.create_backup || self.output_config.create_backup,
        preserve_structure: other.output_config.preserve_structure
          || self.output_config.preserve_structure,
      },
      processing_config: ProcessingConfig {
        processing_mode: other.processing_config.processing_mode.clone(),
        parallel_processing: other.processing_config.parallel_processing
          || self.processing_config.parallel_processing,
        max_threads: other
          .processing_config
          .max_threads
          .or(self.processing_config.max_threads),
        thread_pool_size: other
          .processing_config
          .thread_pool_size
          .max(self.processing_config.thread_pool_size),
        memory_limit: other
          .processing_config
          .memory_limit
          .or(self.processing_config.memory_limit),
        temp_directory: other
          .processing_config
          .temp_directory
          .clone()
          .or(self.processing_config.temp_directory.clone()),
        ...
        retry_config: RetryConfig {
          max_retries: other
            ...
            .retry_config
            .max_retries
            .max(self.processing_config.retry_config.max_retries),
          retry_delay: other
            .processing_config
            .retry_config
            .retry_delay
            .min(self.processing_config.retry_config.retry_delay),
          backoff_multiplier: other
            .processing_config
            .retry_config
            .backoff_multiplier
            .max(self.processing_config.retry_config.backoff_multiplier),
          retry_on_timeout: other.processing_config.retry_config.retry_on_timeout
            || self.processing_config.retry_config.retry_on_timeout,
          retry_on_network_error: other.processing_config.retry_config.retry_on_network_error
            || self.processing_config.retry_config.retry_on_network_error,
        },
      },
      quality_config: QualityConfig {
        ...
        quality_level: other
          .quality_config
          .quality_level
          .max(self.quality_config.quality_level),
        preserve_quality: other.quality_config.preserve_quality
          || self.quality_config.preserve_quality,
      ...
      performance_config: PerformanceConfig {
        ...
        gpu_acceleration: other.performance_config.gpu_acceleration
          || self.performance_config.gpu_acceleration,
        hardware_acceleration: other.performance_config.hardware_acceleration
          || self.performance_config.hardware_acceleration,
        cache_enabled: other.performance_config.cache_enabled
          || self.performance_config.cache_enabled,
        cache_size: other
          .performance_config
          .cache_size
          .or(self.performance_config.cache_size),
        cache_directory: other
          .performance_config
          .cache_directory
          .clone()
          .or(self.performance_config.cache_directory.clone()),
      },
      metadata_config: MetadataConfig {
        preserve_metadata: other.metadata_config.preserve_metadata
          || self.metadata_config.preserve_metadata,
        ...
        metadata_format: other
          ...
          .metadata_format
          .clone()
          .or(self.metadata_config.metadata_format.clone()),
        custom_metadata: {
