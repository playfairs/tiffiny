...
impl AudioMixer {
  pub fn new(channels: u16) -> Self {
    let master_bus = MixerBus::new("master".to_string(), "Master".to_string(), channels, true);
    ...
    Self {
      ...
      output_buffer: Arc::new(RwLock::new(crate::audio_buffer::AudioBuffer::new(
        channels,
        44100,
        512,
  ...
  pub fn initialize(&mut self, sample_rate: u32, channels: u16, buffer_size: usize) {
    ...
    *output_buffer = crate::audio_buffer::AudioBuffer::new(
      channels,
      sample_rate,
      buffer_size,
      crate::audio_buffer::AudioFormat::F32,
...
impl MixerTrack {
  pub fn new(id: String, name: String, channels: u16) -> Self {
    Self {
      id,
      name,
      input_buffer: Arc::new(RwLock::new(crate::audio_buffer::AudioBuffer::new(
        channels,
        44100,
        512,
        crate::audio_buffer::AudioFormat::F32,
  ...
  pub fn initialize(&self, sample_rate: u32, channels: u16, buffer_size: usize) {
    ...
    *input_buffer = crate::audio_buffer::AudioBuffer::new(
      channels,
      sample_rate,
      buffer_size,
      crate::audio_buffer::AudioFormat::F32,
