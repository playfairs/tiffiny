...
impl AudioFormat {
  ...
  pub fn is_signed(&self) -> bool {
    !matches!(
      self,
      AudioFormat::U8 | AudioFormat::U16 | AudioFormat::U24 | AudioFormat::U32
    )
  }
  ...
  pub fn is_lossless(&self) -> bool {
    matches!(
      self,
      AudioFormat::F32 | AudioFormat::F64 | AudioFormat::I16 | AudioFormat::I24 | AudioFormat::I32
    )
  }
...
impl AudioCodec {
  pub fn is_lossless(&self) -> bool {
    matches!(
      self,
      AudioCodec::PCM | AudioCodec::FLAC | AudioCodec::WAV | AudioCodec::AIFF
    )
  }
  ...
  pub fn get_quality_levels(&self) -> Vec<&'static str> {
    match self {
      ...
      AudioCodec::AAC => vec![
        "64kbps", "96kbps", "128kbps", "160kbps", "192kbps", "256kbps",
      ],
      AudioCodec::OGG => vec![
        "64kbps", "96kbps", "128kbps", "160kbps", "192kbps", "256kbps",
      ],
    ...
    if let (Some(bit_rate), Some(duration)) = (self.bit_rate, self.duration) {
      ...
      Some(
        (self.sample_rate as f64
          ...
          * self.sample_format.bytes_per_sample() as f64
          * duration) as u64,
      )
    } else {
      None
