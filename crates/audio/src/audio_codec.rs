...
pub trait AudioEncoder: Send + Sync {
    fn encode(&mut self, input: &crate::audio_buffer::AudioBuffer) -> Result<EncodingResult, Box<dyn std::error::Error>>;
...
impl AudioCodec {
    ...
    pub fn encode(&mut self, input: &crate::audio_buffer::AudioBuffer, params: CodecParameters) -> Result<EncodingResult, Box<dyn std::error::Error>> {
    ...
    pub fn decode(&mut self, data: &[u8], format: &crate::audio_format::AudioFormatInfo) -> Result<DecodingResult, Box<dyn std::error::Error>> {
    ...
    pub fn get_optimal_parameters(&self, input: &crate::audio_buffer::AudioBuffer, target_bitrate: Option<u32>) -> CodecParameters {
    ...
    pub fn estimate_output_size(&self, input: &crate::audio_buffer::AudioBuffer, params: &CodecParameters) -> usize {
...
impl AudioDecoder for Mp3Decoder {
    ...
    fn simulate_mp3_decoding(&self, data: &[u8]) -> Result<(crate::audio_buffer::AudioBuffer, crate::audio_format::AudioFormatInfo), Box<dyn std::error::Error>> {
        ...
        let buffer = crate::audio_buffer::AudioBuffer::new(2, 44100, samples_per_channel, crate::audio_format::AudioFormat::F32);
