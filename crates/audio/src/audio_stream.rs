...
impl AudioStream {
    pub fn new(
        ...
        Self {
            ...
            buffer: Arc::new(RwLock::new(
                crate::audio_buffer::AudioBuffer::new(channels, sample_rate, buffer_size, crate::audio_buffer::AudioFormat::F32)
            )),
            event_sender,
    ...
    pub async fn start(&self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        *state = StreamState::Starting;
        let _ = self.event_sender.send(StreamEvent::StateChanged(StreamState::Starting));
        ...
        *state = StreamState::Running;
        let _ = self.event_sender.send(StreamEvent::StateChanged(StreamState::Running));
    ...
    pub async fn stop(&self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        *state = StreamState::Stopping;
        let _ = self.event_sender.send(StreamEvent::StateChanged(StreamState::Stopping));
        ...
        *state = StreamState::Stopped;
        let _ = self.event_sender.send(StreamEvent::StateChanged(StreamState::Stopped));
    ...
    pub fn set_callback(&mut self, callback: Arc<dyn Fn(&mut crate::audio_buffer::AudioBuffer) + Send + Sync>) {
    ...
    pub fn set_sample_rate(&mut self, sample_rate: u32) {
        ...
        *buffer = crate::audio_buffer::AudioBuffer::new(self.channels, sample_rate, self.buffer_size, crate::audio_buffer::AudioFormat::F32);
    }
    ...
    pub fn set_channels(&mut self, channels: u16) {
        ...
        let mut buffer = self.buffer.write();
        *buffer = crate::audio_buffer::AudioBuffer::new(channels, self.sample_rate, self.buffer_size, crate::audio_buffer::AudioFormat::F32);
    }
    ...
    pub fn set_buffer_size(&mut self, buffer_size: usize) {
        ...
        let mut buffer = self.buffer.write();
        *buffer = crate::audio_buffer::AudioBuffer::new(self.channels, self.sample_rate, buffer_size, crate::audio_buffer::AudioFormat::F32);
    }
...
impl Default for AudioStream {
    fn default() -> Self {
        Self::new(
            crate::audio_engine::StreamConfig::default(),
            44100,
            2,
            512,
        )
